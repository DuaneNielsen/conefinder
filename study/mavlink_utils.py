...
def read_loop(m):
    while (True):
        ...
        if msg_type == "BAD_DATA":
            ...
            param_id = msg.param_id.decode('utf-8')
...
def main():
    ...
    parser.add_option("--check_arm_require", action='store_true', default=False)
    ...
    if opts.check_arm_require:
        msg = pymavlink.MAVLink_param_request_read_message(
